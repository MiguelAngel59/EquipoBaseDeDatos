...
(16,16,16,'ITJ-4004','Mexicana','José','Pérez','Sánchez','1978-09-25'),
...
(25,21,25,'WJA-1313','Canadiense','Emily','Miller','Scott','1992-03-19');

-- Vuelo
INSERT INTO vuelo (id_vuelo,id_avion,id_piloto,id_origen,id_destino,estado,etd,eta,precio) VALUES

(1,1,7,20,19,'FINALIZADO','2025-09-25','2025-09-25',3200.50),
(2,10,14,14,13,'PROGRAMADO','2025-10-03','2025-10-03',1950.00),
(3,9,3,19,21,'EN_VUELO','2025-09-29','2025-09-29',9800.00),
(4,8,2,3,5,'CANCELADO','2025-09-28','2025-09-28',2500.00),
(5,12,5,5,14,'PROGRAMADO','2025-10-15','2025-10-15',3100.00),
(6,7,19,21,13,'PROGRAMADO','2025-11-01','2025-11-01',6550.70),
(7,2,17,20,14,'FINALIZADO','2025-09-20','2025-09-20',4800.00),
(8,3,18,19,20,'PROGRAMADO','2025-10-22','2025-10-22',3900.00),
(9,11,15,15,24,'PROGRAMADO','2025-10-05','2025-10-05',1550.25),
(10,13,13,14,5,'PROGRAMADO','2025-10-18','2025-10-18',4100.00),
(11,5,24,19,20,'FINALIZADO','2025-09-27','2025-09-27',2950.00),
(12,22,1,16,1,'PROGRAMADO','2025-10-20','2025-10-20',2800.00),
(13,13,13,13,19,'PROGRAMADO','2025-10-01','2025-10-02',5200.00),
(14,14,14,14,15,'PROGRAMADO','2025-10-02','2025-10-03',2100.00),
(15,15,15,15,16,'EN_VUELO','2025-10-03','2025-10-04',1850.50),
(16,16,16,16,17,'CANCELADO','2025-10-04','2025-10-05',1300.00),
(17,17,17,19,20,'FINALIZADO','2025-10-05','2025-10-06',760.00),
(18,18,18,20,13,'PROGRAMADO','2025-10-09','2025-10-10',8800.00),
(19,18,18,13,20,'FINALIZADO','2025-10-07','2025-10-08',5400.75),
(20,20,20,13,24,'PROGRAMADO','2025-10-08','2025-10-09',1850.00),
(21,21,21,17,18,'PROGRAMADO','2025-10-09','2025-10-10',720.00),
(22,21,21,18,19,'PROGRAMADO','2025-10-10','2025-10-11',450.00),
(23,23,23,23,22,'PROGRAMADO','2025-10-11','2025-10-12',950.00),
(24,24,24,19,13,'PROGRAMADO','2025-10-12','2025-10-13',7200.00),
(25,25,25,21,13,'PROGRAMADO','2025-10-13','2025-10-14',6200.00);
...
UPDATE vuelo 
SET etd = '2025-10-04', eta = '2025-10-05', precio = 9200 
WHERE id_vuelo = 18;
